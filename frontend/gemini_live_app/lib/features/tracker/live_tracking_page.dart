...
import 'package:vision_aid_app/features/tracker/tracking_controller.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        shape: const RoundedRectangleBorder(
          side: BorderSide(width: 4, color: Color(0xFF20563F)),
            ...
            child: FlutterMap(
              ...
              children: [
                TileLayer(
                  ...
                  userAgentPackageName: 'com.anudeep.vision_aid_app',
                ),
                MarkerLayer(
                  markers: [
                    if (_firebaseUserLocation != null)
